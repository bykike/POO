<?php
	...
	// Como prueba, utilizamos var_dump() para mostrar la estrucrura del contenido del objeto
	...
	// Mostrar la estructura del contido de $libro_phpoo
	var_dump( $libro_phpoo );
